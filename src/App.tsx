...
type AppActions =
  ...
  | {type: 'loading'}
  | {type: 'userAuthChanged'; user: FirebaseAuthTypes.User | null};
        ...
        <GestureHandlerRootView>
          <NavigationContainer>
            <Stack.Navigator initialRouteName={getInitialRoute()}>
              <Stack.Screen
                name={ScreenRouteNames.Onboarding}
                component={OnboardingScreen}
                options={headerParams}
              />
              <Stack.Screen
                name={ScreenRouteNames.Login}
